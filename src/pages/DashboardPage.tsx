    ...
    <div className="flex-1 w-full max-w-6xl mx-auto flex flex-col p-6 overflow-y-auto animate-in fade-in duration-500">
      <div className="flex items-center justify-between mb-8">
        ...
        <button
          ...
          className={`px-4 py-2 rounded-full text-sm font-mono flex items-center gap-2 transition-colors ${
            isStreaming
          ...
          <div className="p-6 rounded-2xl bg-black/40 border border-white/10 backdrop-blur-md">
            ...
            <div className="space-y-3">
              {keys.filter((k: any) => k.status === 'active').slice(0, 4).map((k: any) => (
                <div key={k.id} className="p-3 rounded-xl bg-white/5 border border-white/5 flex items-center justify-between">
                  <div>
